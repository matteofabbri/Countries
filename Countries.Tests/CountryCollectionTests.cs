...
public class CountryCollectionTests
{
    ...
    [TestCase("Americas")]
    [TestCase("Oceania")]
    public void All_EachCountry_ShouldHaveKnownRegionOrEmpty(string region)
    {
        var countries = Country.All.Where(c => c.Region == region);
        Assert.That(countries, Is.Not.Empty, $"Region '{region}' should have at least one country");
    }
